...
const Projects = () => {
  ...
  {
    id:3,
    project_Name:'Color-gradient Generator',
    icon:<FaCalculator></FaCalculator>,
    discription:'A color gradient generator is a tool that allows users to create smooth transitions between two colors',
  ...
  const [projectlist2,setProjectList2]=useState([
    {
      id:4,
      project_Name:'Text To Speech Convertor',
      icon: <TfiYoutube/>,
      discription:'A text-to-speech (TTS) converter transforms written text into spoken words using synthesized voice technology. It is commonly used for accessibility, language learning, and creating audio content.',
      secdiscription:"Using React.js "
    },
    {
      id:5,
    ...
    {
      id:6,
      project_Name:'Calculator And OTP Generator',
      icon:<FaLaptopCode></FaLaptopCode>,
      discription:'	A calculator and OTP generator/validator performs basic arithmetic and creates secure one-time passwords for authentication. It also validates ',
      secdiscription:'Using-HTML,CSS,JavaScript'
    },
